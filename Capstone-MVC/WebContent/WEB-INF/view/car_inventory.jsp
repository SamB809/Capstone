...
<div style="margin-left: 30px; margin-top: 50px;">
  <div class="row mt-5">
    <div class="col-sm-4">
      <div class="card">
    <img src="${tempCar.cUrl}" class="card-img-top" width="100%">
    <div class="card-body pt-0 px-0">
      <div class="d-flex flex-row justify-content-between mb-0 px-3">
        <small class="text-muted mt-1">Price</small>
        <h6>&dollar;${tempCar.cPrice}&ast;</h6>
      </div>
      <hr class="mt-2 mx-3">
		<div class="d-flex flex-row justify-content-between px-3 pb-4">
        <div class="d-flex flex-column"><span class="text-muted">Name</span></div>
        <div class="d-flex flex-column"><h5 class="mb-0">${tempCar.cYear}&emsp;${tempCar.cName}</h5></div>
      </div>
      <div class="d-flex flex-row justify-content-between px-3 pb-4">
        <div class="d-flex flex-column"><span class="text-muted">Color</span></div>
        <div class="d-flex flex-column"><h5 class="mb-0">${tempCar.cColor}</h5></div>
      </div>
        <div class="d-flex flex-row justify-content-between px-3 pb-4">
        <div class="d-flex flex-column"><span class="text-muted">Mileage</span></div>
        <div class="d-flex flex-column"><h5 class="mb-0">${tempCar.cMileage}</h5><small class="text-muted">Miles</small></div>
      </div>
