    ...
    <header>
        ...
        <div class="collapse navbar-collapse" id="navbarText">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
            <a class="nav-link" href="http://localhost:8785/login">Admin</a>
            </li>
          </ul>
                 <form class="nav-item">
              <a class="nav-link btn2" href="http://localhost:8081/Capstone-MVC/customer/my_cart">Checkout</a>
    		                   ...
    		                   <form class="nav-item" style="margin-left: 10px;">
              <a class="nav-link btn2" href="http://localhost:8081/Capstone-MVC/customer/main-page.html">Logout</a>
      ...
      <div class="header-container">
        <div class="header-container-inner">
          ...
          <a href="http://localhost:8081/Capstone-MVC/customer/inventory"  class="btn">Buy a Car</a>
        </div>
      </div>
    </header>
